                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class='row'>
                                    ...
                                    <div class="mb-3">
                                        <label for="section4" class="form-label"> Section4</label>
                                        <textarea name='section4'  id='section4' class="form-control" rows="3">{{-- old("section4", $footer->section4) --}}</textarea>
